...
public class WhiteKingInfo : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool killed;
    ...
    void Start()
    {
        ...
        this.killed = false;
        this.clicked = false;
        this.Object = GameObject.Find("White_King");
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 11) {
                    Debug.Log("WK Clicked");
                    ...
                    board.circleVis(board.ClasstoPos(11));
                    board.nowClicked = 11; //White King : 11
                    ...
                    Debug.Log("WK Unclick");
                    board.circleInvis(board.ClasstoPos(11));
