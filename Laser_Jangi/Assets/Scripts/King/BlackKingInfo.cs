...
public class BlackKingInfo : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool killed;
    ...
    void Start()
    {
        ...
        // btn.onClick.AddListener(BKclick);
    }
        ...
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 1) {
                    ...
                    board.circleVis(board.ClasstoPos(1));
                    board.nowClicked = 1; //Black King : 1
                    ...
                    Debug.Log("BK Unclick");
                    board.circleInvis(board.ClasstoPos(1));
