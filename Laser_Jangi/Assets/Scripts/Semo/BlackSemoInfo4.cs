...
public class BlackSemoInfo4 : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool killed;
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 5) {
                    Debug.Log("BS4 Clicked");
                    ...
                    board.circleVis(board.ClasstoPos(5));
                    board.nowClicked = 5; //White King : 11
                    ...
                    Debug.Log("BS4 Unclick");
                    board.circleInvis(board.ClasstoPos(5));
