...
public class WhiteSemoInfo4 : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool killed;
    ...
    void Start()
    {
        ...
        this.killed = false;
        this.clicked = false;
        this.Object = GameObject.Find("White_Semo4");
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 15) {
                    Debug.Log("WS4 Clicked");
                    ...
                    board.circleVis(board.ClasstoPos(15));
                    board.nowClicked = 15; //White King : 11
                    ...
                    Debug.Log("WS4 Unclick");
                    board.circleInvis(board.ClasstoPos(15));
