...
public class BlackSemoInfo2 : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool killed;
    ...
    void Start()
    {
        ...
        this.killed = false;
        this.clicked = false;
        this.Object = GameObject.Find("Black_Semo2");
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 3) {
                    Debug.Log("BS2 Clicked");
                    ...
                    board.circleVis(board.ClasstoPos(3));
                    board.nowClicked = 3; //White King : 11
                    ...
                    Debug.Log("BS2 Unclick");
                    board.circleInvis(board.ClasstoPos(3));
