...
public class BlackSemoInfo1 : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool killed;
    ...
    void Start()
    {
        ...
        this.killed = false;
        this.clicked = false;
        this.Object = GameObject.Find("Black_Semo1");
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 2) {
                    Debug.Log("BS1 Clicked");
                    ...
                    board.circleVis(board.ClasstoPos(2));
                    board.nowClicked = 2; //White King : 11
                    ...
                    Debug.Log("BS1 Unclick");
                    board.circleInvis(board.ClasstoPos(2));
