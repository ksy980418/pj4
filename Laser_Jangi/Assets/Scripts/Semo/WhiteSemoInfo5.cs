...
public class WhiteSemoInfo5 : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool killed;
    ...
    void Start()
    {
        ...
        this.killed = false;
        this.clicked = false;
        this.Object = GameObject.Find("White_Semo5");
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 16) {
                    Debug.Log("WS5 Clicked");
                    ...
                    board.circleVis(board.ClasstoPos(16));
                    board.nowClicked = 16; //White King : 11
                    ...
                    Debug.Log("WS5 Unclick");
                    board.circleInvis(board.ClasstoPos(16));
