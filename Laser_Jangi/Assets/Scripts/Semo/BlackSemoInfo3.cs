...
public class BlackSemoInfo3 : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool killed;
    ...
    void Start()
    {
        ...
        this.killed = false;
        this.clicked = false;
        this.Object = GameObject.Find("Black_Semo3");
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 4) {
                    Debug.Log("BS3 Clicked");
                    ...
                    board.circleVis(board.ClasstoPos(4));
                    board.nowClicked = 4; //White King : 11
                    ...
                    Debug.Log("BS3 Unclick");
                    board.circleInvis(board.ClasstoPos(4));
