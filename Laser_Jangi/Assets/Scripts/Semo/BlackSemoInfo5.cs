...
public class BlackSemoInfo5 : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool killed;
    ...
    void Start()
    {
        ...
        this.killed = false;
        this.clicked = false;
        this.Object = GameObject.Find("Black_Semo5");
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 6) {
                    Debug.Log("BS5 Clicked");
                    ...
                    board.circleVis(board.ClasstoPos(6));
                    board.nowClicked = 6; //White King : 11
                    ...
                    Debug.Log("BS5 Unclick");
                    board.circleInvis(board.ClasstoPos(6));
