...
public class WhiteSemoInfo1 : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool killed;
    ...
    void Start()
    {
        ...
        this.killed = false;
        this.clicked = false;
        this.Object = GameObject.Find("White_Semo1");
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 12) {
                    Debug.Log("WS1 Clicked");
                    ...
                    board.circleVis(board.ClasstoPos(12));
                    board.nowClicked = 12; //White King : 11
                    ...
                    Debug.Log("WS1 Unclick");
                    board.circleInvis(board.ClasstoPos(12));
