...
public class WhiteSemoInfo2 : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool killed;
    ...
    void Start()
    {
        ...
        this.killed = false;
        this.clicked = false;
        this.Object = GameObject.Find("White_Semo2");
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 13) {
                    Debug.Log("WS2 Clicked");
                    ...
                    board.circleVis(board.ClasstoPos(13));
                    board.nowClicked = 13; //White King : 11
                    ...
                    Debug.Log("WS2 Unclick");
                    board.circleInvis(board.ClasstoPos(13));
