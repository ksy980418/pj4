...
public class WhiteSplitterInfo : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool clicked;
    ...
    void Start()
    {
        ...
        this.rotation = -1;
        this.clicked = false;
        this.Object = GameObject.Find("White_Splitter");
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 19) {
                    Debug.Log("WS Clicked");
                    ...
                    board.circleVis(board.ClasstoPos(19));
                    board.nowClicked = 19; //White King : 11
                    ...
                    Debug.Log("WS Unclick");
                    board.circleInvis(board.ClasstoPos(19));
