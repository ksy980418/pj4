...
public class BlackNemoInfo2 : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool killed;
    ...
    void Start()
    {
        ...
        this.killed = false;
        this.clicked = false;
        this.Object = GameObject.Find("Black_Nemo2");
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 8) {
                    Debug.Log("BN2 Clicked");
                    ...
                    board.circleVis(board.ClasstoPos(8));
                    board.nowClicked = 8; //White King : 11
                    ...
                    Debug.Log("BN2 Unclick");
                    board.circleInvis(board.ClasstoPos(8));
