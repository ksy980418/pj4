...
public class BlackNemoInfo1 : MonoBehaviour
{
    public int position;
    public int rotation;
    public bool killed;
    ...
    void Start()
    {
        ...
        this.killed = false;
        this.clicked = false;
        this.Object = GameObject.Find("Black_Nemo1");
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0)) {
                ...
                && (float)Input.mousePosition.y <= transform.position.y + half_size_y)
            {
                ...
                if (board.nowClicked != 7) {
                    Debug.Log("BN1 Clicked");
                    ...
                    board.circleVis(board.ClasstoPos(7));
                    board.nowClicked = 7; //White King : 11
                    ...
                    Debug.Log("BN1 Unclick");
                    board.circleInvis(board.ClasstoPos(7));
